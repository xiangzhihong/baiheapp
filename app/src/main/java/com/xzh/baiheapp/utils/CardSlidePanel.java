package com.xzh.baiheapp.utils;
...
import com.xzh.baiheapp.view.CardItemView;
...
public class CardSlidePanel extends ViewGroup {
    ...
    private List<CardDataEntity> dataList; // 存储的数据链表
    ...
    private void orderViewStack() {
        synchronized (obj1) {
            ...
            if (newIndex < dataList.size()) {
                CardDataEntity dataItem = dataList.get(newIndex);
    ...
    public void setData(List<CardDataEntity> dataList) {
     ...
     * 该接口未测试，有需要的同学请自行脑补
     */
    public void appendData(List<CardDataEntity> appendList) {
